...
const int IRPinBand = 53; //de echopin van de ultrasoon voor de bakjes orientatie
const int bandMotorPin = 36; //de pin die aangesloten staat op de MOSFET van de bandmotor
const int LDRPin = A7; //de pin die is aangesloten op de LDR
const int comPinIn = 2; //de pin die wordt gebruikt om te communiceren naar de andere arduino (in)
